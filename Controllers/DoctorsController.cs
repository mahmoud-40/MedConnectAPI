...
public class DoctorsController : ControllerBase
{
    ...
    [SwaggerOperation(
        ...
        description: "Add doctor to provider, Requires Admin or Provider Role\n\n" +
            "If Provider Role, only get doctors assigned to provider\n\n" +
            "Example: `/api/doctors`"
    )]
    ...
    public async Task<IActionResult> GetDoctors()
    {
        ...
        if (User.IsInRole("Provider"))
        {
            ...
            doctors = await unit.DoctorRepository.GetAll();
    ...
    [SwaggerOperation(
        ...
        description: "Get doctor by id, Requires Admin or Provdier Role\n\n" +
            "If Provider Role, only get doctor assigned to provider\n\n" +
    ...
    [SwaggerOperation(
        ...
        description: "Edit doctor data in provider, Requires Admin or Provider Role\n\n" +
            "If Provider Role, only edit doctor assigned to provider\n\n" +
            "Example: `/api/doctors/1`"
    )]
    ...
    [SwaggerOperation(
        ...
        description: "Delete doctor, Requires Admin or Provider Role\n\n" +
            "If Provider Role, only delete doctor assigned to provider\n\n" +
            "Example: `/api/doctors/1`"
    )]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
